...
const messages: { [locale: string]: NlsBundle } = {
  en: {
    ...
    // 扩展注释功能
    'msg.annotationAdded': '{0} annotation added ({1} total)',
    'msg.annotationError': 'Annotation error: {0}',
    // 评论功能
    'msg.commentAdded': 'Comment added ({0} total)',
    'msg.commentDeleted': 'Comment deleted ({0} remaining)',
    'msg.commentEdited': 'Comment edited',
    'msg.commentError': 'Comment error: {0}',
    'msg.noComments': 'No comments in this document.',
    'msg.selectComment': 'Select a comment ({0} total)',
    'msg.enterComment': 'Enter your comment',
    'msg.commentPlaceholder': 'Type your comment here...',
    'msg.editComment': 'Edit comment',
    'action.edit': 'Edit',
    // 便签功能
    'msg.stickyNoteAdded': 'Sticky note added ({0} total)',
    'msg.stickyNoteDeleted': 'Sticky note deleted ({0} remaining)',
    'msg.stickyNoteError': 'Sticky note error: {0}',
    'msg.noStickyNotes': 'No sticky notes in this document.',
    'msg.selectStickyNote': 'Select a sticky note ({0} total)',
    'msg.enterStickyNoteContent': 'Enter sticky note content',
    'msg.stickyNotePlaceholder': 'Type your note here...',
    // 绘图功能
    'msg.drawingAdded': 'Drawing added ({0} total)',
    'msg.drawingDeleted': 'Drawing deleted ({0} remaining)',
    'msg.drawingsCleared': '{0} drawings cleared.',
    'msg.drawingModeStarted': 'Drawing mode started ({0})',
    'msg.drawingModeStopped': 'Drawing mode stopped',
    'msg.noDrawings': 'No drawings in this document.',
    'msg.selectDrawing': 'Select a drawing ({0} total)',
    'msg.selectDrawingType': 'Select drawing type',
    'drawing.rectangle': 'Rectangle',
    'drawing.circle': 'Circle',
    'drawing.arrow': 'Arrow',
    'drawing.freehand': 'Freehand',
    // 注释导出
    'msg.noAnnotationsToExport': 'No annotations to export.',
    'msg.annotationsRestored': 'Annotations restored.',
    'msg.selectAnnotationType': 'Select annotation type',
    'annotation.highlights': 'Highlights',
    'annotation.textAnnotations': 'Text Annotations',
    'annotation.comments': 'Comments',
    'annotation.stickyNotes': 'Sticky Notes',
  ...
  'zh-cn': {
    ...
    // 扩展注释功能
    'msg.annotationAdded': '已添加{0}注释（共 {1} 个）',
    'msg.annotationError': '注释错误：{0}',
    // 评论功能
    'msg.commentAdded': '已添加评论（共 {0} 个）',
    'msg.commentDeleted': '已删除评论（剩余 {0} 个）',
    'msg.commentEdited': '评论已编辑',
    'msg.commentError': '评论错误：{0}',
    'msg.noComments': '此文档中没有评论。',
    'msg.selectComment': '选择评论（共 {0} 个）',
    'msg.enterComment': '输入评论内容',
    'msg.commentPlaceholder': '在此输入评论...',
    'msg.editComment': '编辑评论',
    'action.edit': '编辑',
    // 便签功能
    'msg.stickyNoteAdded': '已添加便签（共 {0} 个）',
    'msg.stickyNoteDeleted': '已删除便签（剩余 {0} 个）',
    'msg.stickyNoteError': '便签错误：{0}',
    'msg.noStickyNotes': '此文档中没有便签。',
    'msg.selectStickyNote': '选择便签（共 {0} 个）',
    'msg.enterStickyNoteContent': '输入便签内容',
    'msg.stickyNotePlaceholder': '在此输入笔记...',
    // 绘图功能
    'msg.drawingAdded': '已添加绘图（共 {0} 个）',
    'msg.drawingDeleted': '已删除绘图（剩余 {0} 个）',
    'msg.drawingsCleared': '已清除 {0} 个绘图。',
    'msg.drawingModeStarted': '绘图模式已启动（{0}）',
    'msg.drawingModeStopped': '绘图模式已停止',
    'msg.noDrawings': '此文档中没有绘图注释。',
    'msg.selectDrawing': '选择绘图（共 {0} 个）',
    'msg.selectDrawingType': '选择绘图类型',
    'drawing.rectangle': '矩形',
    'drawing.circle': '圆形',
    'drawing.arrow': '箭头',
    'drawing.freehand': '自由绘制',
    // 注释导出
    'msg.noAnnotationsToExport': '没有可导出的注释。',
    'msg.annotationsRestored': '注释已恢复。',
    'msg.selectAnnotationType': '选择注释类型',
    'annotation.highlights': '高亮',
    'annotation.textAnnotations': '文本注释',
    'annotation.comments': '评论',
    'annotation.stickyNotes': '便签',
    'annotation.drawings': '绘图',
  },
};
